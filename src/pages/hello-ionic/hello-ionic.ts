...
export class HelloIonicPage {
  ...
  buttonClick(val:any){
    let myModal = this.modalCtrl.create(ModalPage, { 'prod': val });
    myModal.present();
    /*console.log(val);
...
export class ModalPage {
  producto: any={name:"abejitas bailarinas",precio:"13",venta:"22"};

  
  constructor(public viewCtrl: ViewController,params: NavParams) {
    this.producto = params.get('prod');
  } 
  dismiss() {
